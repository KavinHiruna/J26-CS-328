...
try:
    ...
    # ============================================================
    # CREATE ATTACK TYPE FROM DATASET
    # ============================================================

    # Find Attack_type column
    ...
    # ------------------------------------------------------------
    # USE THE ACTUAL DATASET ATTACK NAME
    # ------------------------------------------------------------
    ...
    if attack_type_column is not None:
        ...
        # If Attack_type does not exist,
        # show a clear error instead of assigning Unknown
        st.error(
            "The dataset does not contain an 'Attack_type' column."
        )

        incident_data["Attack Type"] = "Unknown"

    # ========================================================
    # CREATE ATTACK TYPE
    # ========================================================

    # Find the attack type column regardless of capitalization
    # or small naming differences.

    attack_type_column = None

    possible_attack_columns = [
        "Attack_type",
        "Attack Type",
        "attack_type",
        "attack type",
